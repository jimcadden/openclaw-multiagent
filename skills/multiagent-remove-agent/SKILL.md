---
name: multiagent-remove-agent
description: Remove an agent from the multiagent workspace. Use when asked to remove, delete, or decommission an agent. Handles openclaw.json cleanup, Telegram config removal, workspace archiving, and git commit.
